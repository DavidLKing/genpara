...
class BertBatch:
    ...
    def extract(self, sentences, batchSize, layer):
        ...
        while batchLoc <= total:
            ...
            if toID != []:
               ...
               [tensors.append(np.asarray(x.tolist())) for x in embeddings[layer]]
               
               """The BERT is proven to have 12 layers ([0] is the last layer)"""
