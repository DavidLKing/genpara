...
metrics = [(glove_src_para_sim, 'glove_src_para_sim'),
    (glove_src_para_dist, 'glove_src_para_dist'),
    (glove_src_para_david, 'glove_src_para_david'),
    (glove_src_orig_sim, 'glove_src_orig_sim'),
    (glove_src_orig_dist, 'glove_src_orig_dist'),
    (glove_src_orig_david, 'glove_src_orig_david'),
    (glove_orig_para_sim, 'glove_orig_para_sim'),
    (glove_orig_para_dist, 'glove_orig_para_dist'),
    (glove_orig_para_david, 'glove_orig_para_david'),
    (glove_align_para_sim, 'glove_align_para_sim'),
    (glove_align_para_dist, 'glove_align_para_dist'),
    (glove_align_para_david, 'glove_align_para_david'),
    (w2v_src_para_sim, 'w2v_src_para_sim'),
    (w2v_src_para_dist, 'w2v_src_para_dist'),
    (w2v_src_para_david, 'w2v_src_para_david'),
    (w2v_src_orig_sim, 'w2v_src_orig_sim'),
    (w2v_src_orig_dist, 'w2v_src_orig_dist'),
    (w2v_src_orig_david, 'w2v_src_orig_david'),
    (w2v_orig_para_sim, 'w2v_orig_para_sim'),
    (w2v_orig_para_dist, 'w2v_orig_para_dist'),
    (w2v_orig_para_david, 'w2v_orig_para_david'),
    (w2v_align_para_sim, 'w2v_align_para_sim'),
    (w2v_align_para_dist, 'w2v_align_para_dist'),
    (w2v_align_para_david, 'w2v_align_para_david'),
    (elmo_src_para_sim, 'elmo_src_para_sim'),
    (elmo_src_para_dist, 'elmo_src_para_dist'),
    (elmo_src_para_david, 'elmo_src_para_david'),
    (elmo_src_orig_sim, 'elmo_src_orig_sim'),
    (elmo_src_orig_dist, 'elmo_src_orig_dist'),
    (elmo_src_orig_david, 'elmo_src_orig_david'),
    (elmo_orig_para_sim, 'elmo_orig_para_sim'),
    (elmo_orig_para_dist, 'elmo_orig_para_dist'),
    (elmo_orig_para_david, 'elmo_orig_para_david'),
    (elmo_align_para_sim, 'elmo_align_para_sim'),
    (elmo_align_para_dist, 'elmo_align_para_dist'),
    (elmo_align_para_david, 'elmo_align_para_david')]
